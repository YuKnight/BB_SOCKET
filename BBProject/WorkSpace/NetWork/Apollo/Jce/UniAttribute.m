...
- (void)setInAttributes:(UniAttribute *)attrs withName:(NSString *)name
{
    JceOutputStream *stream = [JceOutputStream streamWithCapability:(int)self.length];
...
- (void)setInAttributes:(UniAttribute *)attrs withName:(NSString *)name
{
    JceOutputStream *stream = [JceOutputStream streamWithCapability:(int)[self lengthOfBytesUsingEncoding:NSUTF8StringEncoding]];
