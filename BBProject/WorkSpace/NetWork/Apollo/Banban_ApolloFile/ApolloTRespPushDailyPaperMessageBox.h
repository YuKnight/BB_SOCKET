...
@interface ApolloTRespPushDailyPaperMessageBox : JceObjectV2
...
@property (nonatomic, assign, JV2_PROP_GS_V2(pushLocation,setPushLocation:)) JceInt64 JV2_PROP_NM(r,2,pushLocation);
