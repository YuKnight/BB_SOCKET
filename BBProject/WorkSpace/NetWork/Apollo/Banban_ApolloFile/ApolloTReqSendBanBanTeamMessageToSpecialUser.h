...
@interface ApolloTReqSendBanBanTeamMessageToSpecialUser : JceObjectV2

@property (nonatomic, retain, JV2_PROP_GS_V2(message,setMessage:)) ApolloTChatMessage* JV2_PROP_NM(o,0,message);
